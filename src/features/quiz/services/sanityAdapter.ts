...
import type {
  ...
  LocalizedText,
} from '@/features/quiz/sanity/types'
import type { QuestionBankLanguage, Question } from '@/features/quiz/dictionaries/quizDictionary'
...
/**
 * Получает AI промпт из квиза Sanity для конкретной роли (только русский).
 */
